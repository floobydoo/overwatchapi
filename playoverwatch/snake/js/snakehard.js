    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            if (config.fullScreen) {
                fullScreenText = "F11 to play in fullscreen";   
            }
            welcomeTxt.innerHTML = "Dank Snank<p></p>Use <strong>Arrow Keys</strong> to play the game. " + fullScreenText + "<p></p>";
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "Dank Snank<p></p>Hah, you failed nerd.<p></p>";
        ...
        */ 
        me.setupPlayingField = function () {
            ...
            if (config.fullScreen === true) {
                cTop = 0;
                cLeft = 0;
                cWidth = getClientWidth()-0;
                cHeight = getClientHeight()-0;
